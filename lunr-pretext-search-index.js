...
},
{
  ...
  "type": "Activity",
  "number": "1.4.1",
  "title": "Human Venn Diagrams.",
  "body": " Human Venn Diagrams  Your class will now be a human Venn diagram (This works best in an open area). Each of you will receive an idex card. On your index card, write (1) an integer, (2) a color, and (3) an animal.  For example, your card may include   73    tangerine    pangolin.     Your instructor will designate one part of the room (or area) for set , another for set , and a third area for set .  Now for the game. Your instructor will call out (or write on the board) what the three sets represent. At that point, you must move to the location on the Venn diagram that fits your card.  For example, suppose your instructor calls out (or writes) \" is the set even integers, is the set of warm colors (yellows, oranges, reds), and is the set of predatory animals. Compare those sets to your card. It appears is the only set you are a part of, so move on to that section of the Venn diagram. The quicker, the better.     Play a few rounds.  "
},
{
  "id": "act-set2",
  "level": "2",
